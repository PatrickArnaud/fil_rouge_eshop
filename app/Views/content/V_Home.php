...
<section class="my-recipe p-3">
    <div class="container cols-12">
        <h3 class="top_recipe cols-12" style="text-align: center;">NOS TOPS RECETTES</h3>
        <div class="row row-cols-1 row-cols-md-3 g-4 mt-5">
            <div class="col">
                <div class="card h-100">
                <img src="https://via.placeholder.com/550x750" class="card-img-top default-img"  alt="#">
                <div class="card-body">      
                    <p class="card-text">Ranking stars</p> <br>
                    <h5 class="card-title">Nom Recette</h5>
...
<section class="my-ingredients p-3">
    <div class="container cols-12">
        <h3 class="top_ingredient cols-12" style="text-align: center;">NOS TOPS INGREDIENTS</h3>

        <div class="row row-cols-1 row-cols-md-3 g-4 mt-5 d-flex">
